...
const DesignConfigurator = ({
  ...
  async function saveConfiguration() {
    try {
      ...
      const blob = base64DataToBlop(base64Data, "image/png")
    ...
    function base64DataToBlop(base64: string, mimeType: string){
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div
      ref={containerRef}
        className="relative h-[37.5rem] overflow-hidden col-span-2 w-full m-w-4xl 
      flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 pt-12 text-center 
                  ...
                  ({ name, options: selectableOptions }) => (
                    <RadioGroup
                      ...
                      onChange={(val) => {
                        setOptions((prev) => ({
                          ...prev,
                          // name in brackets [] because name can be materials or finishes (syntax)
                          [name]: val,
                        }));
                      }}
                    >
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          <Radio
                            ...
                            className={({ focus, checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 sm:flex sm:justify-between",
