  ...
  return (
    ...
    <div className='mt-20 grid grid-cols-1 text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
            <div className="grid grid-cols-1 gap-y-8 border-b border-200 py-8 sm:grid-cols-2  sm:gap-x-6 sm:py-6 md:py-10">
                <div className="">
               ...
               <div className="mt-8">
                <div className="bg-gray-50 rounded-lg p-8 mb-4 py-6 sm:rounded-xl sm:p-8">
                    <div className="flow-root text-sm">
                        ...
                        {finish === "textured" ? (<div>
                            ...
                            <p className='font-medium text-gray-900'>{formatPrice(FINISHES.options[1].price / 100)}</p>
                        </div>
                        </div>) : null}

                        {material === "polycarbonate" ? (<div>
                            <div className="flex items-center justify-between py-1 mt-2">
                        ...
                        <div className='my-2 h-px bg-gray-200 md:my-4'/>

                        <div className="flex items-center justify-between py-2">
                            <p className='font-semibold text-gray-900'>Order Total</p>

                            <p className=''>{formatPrice(totalPrice / 100)}</p>
                        </div>
                    </div>
                </div>
