    ...
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4 ">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="/snake-1.png" width={100} height={100}></img>
              </div>
              <div className="relative w-fit tracking-light text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                <h1>
                  Your image on a{" "}
                  <span className="bg-purple-600 px-2 rounded-md text-white">Custom</span>{" "}
                  Phone Case
                </h1>
                ...
                <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                  <div className="space-y-2">
                    <li className="flex gap-1.5 items-center text-left text-xl">
                      <Check className="h-5 w-5 shrink-0 text-purple-600"></Check>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  led to some pretty heavy scratchmarks on all my previous
                  case."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Denis</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-purple-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-32 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                Upload your photo and get{" "}
                <span className="relative px-4 bg-purple-600 text-white rounded-md">
                  Your Own Case{" "}
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-60">
              <img src='/arrow.png' className="absolute top-[25rem] md:top-1/2 -traslate-y-1/2 z-10 left-1/2 -traslate-x-1/2 rotate-90 md:rotate-0"></img>
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" className="rounded-md object-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"></img>
              </div>
